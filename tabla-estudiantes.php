                                ...
                                <section class="Student-Data">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-12 col-lg-3">
                                            ...
                                            <input class="form-control" type="text" id="IDstudent" name="studentID" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="none" aria-label="Cédula" required>
                                        </div>
                                        <!--Country-->
                                        <div class="col-12 col-lg-3">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-12 col-lg-3">
                                            ...
                                            <input class="form-control" type="email" id="studentEmailMEP" name="sEmailMEP" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="none" aria-label="Correo Electrónico MEP">
                                        ...
                                        <div class="col-12 col-lg-3">
                                            ...
                                            <input class="form-control" type="text" id="studentPhone" name="sPhone" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="none" aria-label="Número Celular">
                                        </div>
                                        <!-- First general row -->
