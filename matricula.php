...
<body class="darkmode">
				...
				<section class="Student-Data">
					...
					<d iv class="row mb-5">
						...
						<div class="col-12 col-lg-3">
							...
							<input class="form-control" placeholder="" type="text" id="IDstudent" name="studentID" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="none" aria-label="Cédula" minlength="7" maxlength="12" required>
						</div>
						<!--Country-->
						<div class="col-12 col-lg-3">
					...
					<div class="row mb-5">
						...
						<div class="col-12 col-lg-3">
							...
							<input class="form-control" type="text" id="studentLastName1" name="sLastName1" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="sentences" aria-label="Primer Apellido" required>
						</div>
						<!--Second LastName (Student)-->
						<div class="col-12 col-lg-3">
							<label for="sLastName2" class="binding">Segundo Apellido</label>
							<input class="form-control" type="text" id="studentLastNamew" name="sLastName2" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="sentences" aria-label="Segundo Apellido">
						</div>
						<!--First Name (Student)-->
						<div class="col-12 col-lg-3">
							<label for="sName1" class="binding">Primer Nombre</label>
							<input class="form-control" type="text" id="studentName1" name="sName1" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="sentences" aria-label="Primer Nombre" required>
						</div>
						<!--Second Name (Student)-->
						<div class="col-12 col-lg-3">
							<label for="sName2" class="binding">Segundo Nombre</label>
							<input class="form-control" type="text" id="studentName2" name="sName2" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="sentences" aria-label="Segundo Nombre">
						</div>
					</div>
					<!-- Second row -->
					...
					<div class="row mb-5">
						...
						<div class="col-12 col-lg-6">
							...
							<textarea class="form-control" rows="3" cols="50" type="text" id="medComments" name="medicalComments" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="sentences" aria-label="Comentarios Médicos"></textarea>
						</div>
						<!--Student Comments-->
						<div class="col-12 col-lg-6">
							<label for="studentComments" class="binding">Comentarios del Estudiante</del></label>
							<textarea class="form-control" rows="3" cols="50" type="text" id="stdComments" name="studentComments" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="sentences" aria-label="Comentarios del Estudiante"></textarea>
						</div>
					</div>
					<!-- Third row -->
					...
					<div class="row mb-5">
						...
						<div class="col-12 col-lg-3">
							...
							<div class="input-group">
								<input class="form-control" placeholder="cedula@est.mep.go.cr" type="email" id="studentEmailMEP" name="sEmailMEP" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="none" aria-label="Correo Electrónico MEP">
							</div>
						</div>
						<!--Student Email-->
						<div class="col-12 col-lg-3">
							<label for="sEmail" class="binding">Correo Personal</label>
							<input class="form-control" type="email" id="studentEmail" name="sEmail" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="none" aria-label="Correo Electrónico">
						</div>
						...
						<div class="col-12 col-lg-9 align-self-end">
							...
							<textarea rows="5" cols="50" class="form-control" type="text" id="stdAddress" name="studentAddress" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="sentences" aria-label="Dirección del Estudiante" required></textarea>
						</div>
					</div>
					<!-- First general row -->
					...
					<div class="row mb-5">
						...
						<div class="col-12 col-lg-3">
							...
							<input class="form-control" type="text" id="studentPolicy" name="sPolicy" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="none" aria-label="Poliza de Seguros">
						</div>
						<!--Scholarship IMAS-->
			...
			<div class="row mb-4">
				<div class="col-12 col-lg-3 mb-5">
					...
					<div class="colum">
						...
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="scholarshipIMAS" name="sIMAS" value="1" tabindex="0" aria-label="IMAS">
							<label for="sIMAS" class="binding">IMAS</label>
						</div>
						<!--Scholarship TRANSPORTE-->
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="scholarshipTRANS" name="sTRANSPORTE" value="1" tabindex="0" aria-label="TRANSPORTE">
							<label for="sTRANSPORTE" class="binding">TRANSPORTE</label>
						</div>
						<!--Scholarship COMEDOR-->
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="scholarshipCOM" name="sCOMEDOR" value="1" tabindex="0" aria-label="COMEDOR">
				...
				<div class="col-12 col-lg-3">
					...
					<div class="colum">
						<!--Image Usage-->
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="imageUSAG" name="iUSAGE" value="1" tabindex="0" aria-label="USO DE IMAGEN">
							<label for="iUSAGE" class="binding">USO DE IMAGEN</label>
						</div>
						<!--Leaving Institution-->
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="leavingINST" name="lINSTITUTION" value="1" tabindex="0" aria-label="SALIDA DE LA INSTITUCIÓN">
							<label for="lINSTITUTION" class="binding">SALIDA DE LA INSTITUCIÓN</label>
						</div>
						<!-- Religion -->
						<div class="form-check">
							<input type="checkbox" class="form-check-input" id="actReligion" name="Religion" value="1" tabindex="0" aria-label="Religión">
		...
		<section class="Manager-Data">
			...
			<d iv class="row mb-5 justify-content-center">
				...
				<div class="col-12 col-lg-3">
					...
					<input class="form-control" type="text" id="IDmanager" name="managerID" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="none" aria-label="Cédula" required>
				</div>
				<!--Country-->
				<div class="col-12 col-lg-3">
			...
			<div class="row mb-5">
				...
				<div class="col-12 col-lg-3">
					...
					<input class="form-control" type="text" id="managertLastName1" name="mLastName1" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="sentences" aria-label="Primer Apellido" required>
				</div>
				<!--Second LastName (Manager)-->
				<div class="col-12 col-lg-3">
					<label for="mLastName2" class="binding">Segundo Apellido</label>
					<input class="form-control" type="text" id="managerLastNamew" name="mLastName2" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="sentences" aria-label="Segundo Apellido">
				</div>
				<!--First Name (Manager)-->
				<div class="col-12 col-lg-3">
					<label for="mName1" class="binding">Primer Nombre</label>
					<input class="form-control" type="text" id="managerName1" name="mName1" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="sentences" aria-label="Primer Nombre" required>
				</div>
				<!--Second Name (Manager)-->
				<div class="col-12 col-lg-3">
					<label for="mName2" class="binding">Segundo Nombre</label>
					<input class="form-control" type="text" id="managerName2" name="mName2" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="sentences" aria-label="Segundo Nombre">
				</div>
			</div>
			...
			<div class="row justify-content-center mb-5">
				...
				<div class="col-12 col-lg-3">
					...
					<input class="form-control" type="email" id="managerEmail" name="mEmail" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="none" aria-label="Correo Electrónico">
				</div>
				<!--Manager Phone Number-->
				<div class="col-12 col-lg-3">
					<label for="mPhone" class="binding">Número Celular</label>
					<input class="form-control" type="text" id="managerPhone" name="mPhone" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="none" aria-label="Número Celular" required>
				</div>
				<div class="col-12 col-lg-3">
					<label for="mPhone2" class="binding">Número Celular (Opcional)</label>
					<input class="form-control" type="text" id="managerPhone" name="mPhone2" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="none" aria-label="Número Celular">
				</div>
			</div>
			...
			<div class="row justify-content-center mb-5">
				...
				<div class="col-12 col-lg-3">
					...
					<input class="form-control" type="text" id="managerEmail" name="AsistentName" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="none" aria-label="Número Celular" required>
				</div>
				<!-- Second name-->
				<div class="col-12 col-lg-3">
					<label for="AsistentLastName" class="binding">Apellido del Asistente</label>
					<input class="form-control" type="text" id="managerPhone" name="AsistentLastName" autocomplete="off" spellcheck="false" tabindex="0" autocapitalize="none" aria-label="Número Celular" required>
				</div>
			</div>
		</section>
	</div>
	...
	<form action="matricula_diurno.php" method="POST" id="form">
